"""
Unified Compression Implementation
Consolidates all compression strategies for KV cache optimization
"""
...
class PyramidCompressor(BaseCompressor):
    ...
    def __init__(self, hidden_size: int, compression_ratio: float = 0.5, num_levels: int = 3, decay_factor: float = 0.8):
